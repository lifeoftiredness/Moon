...
이 코드를 실행시켜보자
![/asset/postImage/kotlin/"2018-07-17-2. 클래스"/ExampleKotlinResult.png](ExampeKotlin실행 결과)
...
![/asset/postImage/kotlin/"2018-07-17-2. 클래스"/initBlock.png](디컴파일 코드)
...
![/asset/postImage/kotlin/"2018-07-17-2. 클래스"/setterAndGetter.png](ExampleKotlin디컴파일)
